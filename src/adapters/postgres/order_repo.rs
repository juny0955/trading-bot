...
impl OrderRepository for PgOrderRepository {
    ...
    async fn record_fill(&self, fill: &Fill) -> Result<(), Error> {
        Self::record_fill(self, fill).await
    }

    async fn find_open(&self, symbol: &str) -> Result<Vec<Order>, Error> {
    ...
    async fn find_by_exchange_id(&self, exchange_id: i64) -> Result<Option<Order>, Error> {
...
impl PgOrderRepository {
    ...
    pub async fn upsert_order(&self, order: &Order) -> Result<(), Error> {
        sqlx::query(
            r#"
            INSERT INTO orders (
    ...
    pub async fn record_fill(&self, fill: &Fill) -> Result<(), Error> {
        sqlx::query(
            r#"
            INSERT INTO fills (
    ...
    pub async fn find_open(&self, symbol: &str) -> Result<Vec<Order>, Error> {
    ...
    pub async fn find_by_exchange_id(&self, exchange_id: i64) -> Result<Option<Order>, Error> {
