...
use crate::order::types::{Fill, Order, OrderSide};
...
mod tests {
    use super::*;
    use crate::order::types::{Order, OrderRequest, OrderSide, OrderType};
    ...
    fn mkt(side: OrderSide, qty: rust_decimal::Decimal) -> Order {
